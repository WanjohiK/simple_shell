...
/**
 * customStrdup - allocate memory for a string to duplicate
...
/**
 * customStrConcat - concatenates two strings,
...
char *customStrConcat(char *s1, char *s2)
{
	...
	len1 = customStrlen(s1);
	len2 = customStrlen(s2);
...
/**
 * customStrNcmp - compare strings up to n bytes
