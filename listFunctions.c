 ...
 * Copy str into the node, set the next node to NULL.
 * If the list is empty, set head to the new node and return it.
 * Traverse the list, set the next element in the list to new, and return it.
 *
 ...
 * If it matches, return the index of the node.
 *
